...
def print_usage():
    ...
    print("  python main.py enhance <command> --file <path/to/file.jpg> [--save <path/to/save>] [--mask <path/to/mask>] [--license <KEY>]")
    ...
    print("  straighten_document | cleanup_document\n")
    ...
    print("Note:")
    print("  --save is optional for analyze/crop_analyze and enhance/cleanup_document.")
    print("  --mask is required for enhance/cleanup_document.")
