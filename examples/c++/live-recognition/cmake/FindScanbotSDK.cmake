...
if (NOT EXISTS ${SCANBOTSDK_DIR})
  ...
  set(URL "https://scanbotsdk-deployment.s3.amazonaws.com/ScanbotSDK-Linux/HZMdMdpCxVuaro3GE4G2gMmt/scanbotsdk-v0.0.1.tgz")
  execute_process(
    COMMAND wget -nc -q -O scanbotsdk.tgz ${URL}
    WORKING_DIRECTORY ${CMAKE_CURRENT_BINARY_DIR}
  )
  execute_process(
    COMMAND tar -xzf scanbotsdk.tgz
    WORKING_DIRECTORY ${CMAKE_CURRENT_BINARY_DIR}
  )
  execute_process(
...
find_library(ScanbotSDK_LIBS
  ...
  HINTS ${SCANBOTSDK_DIR}/lib/${CMAKE_HOST_SYSTEM_PROCESSOR}/
  )
