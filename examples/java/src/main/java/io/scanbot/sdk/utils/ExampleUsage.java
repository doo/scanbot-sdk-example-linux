...
public class ExampleUsage {
    public static void print() {
        ...
        System.out.println("or");
        System.out.println("  ./gradlew run --args='straighten <command> --resource <path/to/resource.jpg> [--license <KEY>]'");
        System.out.println("or");
        System.out.println("  ./gradlew run --args='straighten <command> --file <path/to/file.jpg> [--license <KEY>]'");
        System.out.println();
        ...
        System.out.println();
        System.out.println("Available straighten commands:");
        ...
        System.out.println("  ./gradlew run --args='straighten document --file images/doc.jpg --license <KEY>'");
