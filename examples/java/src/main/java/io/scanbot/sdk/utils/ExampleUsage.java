...
public class ExampleUsage {
    public static void print() {
        ...
        System.out.println("or");
        System.out.println("  ./gradlew run --args='enhance <command> --resource <path/to/resource.jpg> [--save <path/to/save.jpg>] [--mask <path/to/mask.jpg>] [--mask-resource <path/to/mask-resource.jpg>] [--license <KEY>]'");
        System.out.println("or");
        System.out.println("  ./gradlew run --args='enhance <command> --file <path/to/file.jpg> [--save <path/to/save.jpg>] [--mask <path/to/mask.jpg>] [--mask-resource <path/to/mask-resource.jpg>] [--license <KEY>]'");
        System.out.println();
        ...
        System.out.println("  straighten_document | cleanup_document");
        System.out.println();
        System.out.println("Available parse commands:");
        System.out.println("  mrz | barcode_doc");
        System.out.println();
        System.out.println("Note:");
        System.out.println("  The --save argument is optional and used with analyze/crop_analyze and enhance/cleanup_document.");
        System.out.println("  The --mask or --mask-resource argument is required for enhance/cleanup_document.");
        ...
        System.out.println("  ./gradlew run --args='enhance straighten_document --file images/doc.jpg --license <KEY>'");
        System.out.println("  ./gradlew run --args='enhance cleanup_document --file ../../test-scripts/test-images/highlighted.png --mask ../../test-scripts/test-images/highlighted_mask_001.png --save out/cleaned.jpg --license <KEY>'");
